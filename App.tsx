...
import { Activity, Lock, User, ExternalLink, TrendingUp, Database, ArrowUpRight, ArrowDownRight, Wallet, BarChart2, Pickaxe, Clock, Shield, Menu, X, Rabbit, FileText, Globe, PlayCircle, Newspaper, ArrowLeft, Share2, Gift, CheckCircle, Loader2, Download, ArrowRight } from 'lucide-react';
...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<'markets' | 'trade' | 'news' | 'airdrop'>('markets');
             ...
             <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-[#1e2329] border border-[#2b3139] rounded-2xl p-8 relative overflow-hidden">
                   ...
                   <div className="relative z-10">
                      ...
                      <div className={`flex items-center gap-4 transition-opacity duration-500 ${isWalletConnected ? 'opacity-100' : 'opacity-30 pointer-events-none'}`}>
